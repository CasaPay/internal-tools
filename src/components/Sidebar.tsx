...
import { Users2, BarChart3, PieChart, Mic, Activity, ChevronLeft, ChevronRight } from 'lucide-react';

export type ToolId = 'prospect' | 'calculator' | 'unit-economics' | 'training' | 'cascade';
